...
<body class=" bg-slate-100 text-slate-900">
    <header class=" bg-slate-800 shadow-lg">
        <nav>
            ...
            <a href="{{ route('tecnicos.index') }}" class="nav-link">Técnicos</a>
            <a href="{{ route('equipos.index') }}" class="nav-link">Equipos</a>
            <a href="{{ route('equiposdetrabajo.index') }}" class="nav-link">Equipos de Trabajo</a>
            <a href="{{ route('vehiculos.index') }}" class="nav-link">Vehículos</a>
            <a href="{{ route('ordenes.index') }}" class="nav-link">Órdenes</a>
